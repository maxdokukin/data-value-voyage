...
# Fetch decade purchasing power data
...
# Compute affordability comparison
tmpl = df_1920s.set_index('name')['good_unit'].to_dict()
...
for name in goods_list:
    ...
    dlt = v21 - v20
    pct = round((dlt / v20 * 100),1) if v20 else 0
    records.append({
    ...
    html.Div(className='section', children=[
        ...
        html.Div(className='table-container', children=[
            dash_table.DataTable(
                ...
                data=records,
                style_table={'width':'100%'}, style_cell={'padding':'8px','textAlign':'left'}, style_header={'fontWeight':'bold'}
            )
        ])
    ]),
